...
class ProductsController < ApplicationController
  ...
  def show
    ...
    if current_user.nil?
      ...
      flash[:alert] = "Il faut modifier son profil si vous voulez acheter ou louer une oeuvre!#{view_context.link_to(' Modifier', edit_user_registration_path)}.".html_safe 
    end
  end
